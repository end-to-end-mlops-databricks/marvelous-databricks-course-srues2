...
with mlflow.start_run(tags={"branch": "week1and2_stanruessink", "git_sha": f"{git_sha}"}) as run:
    ...
    mlflow.pyfunc.log_model(
        ...
        ],  # if you run in databricks UI, path can be Volume. Now I'm running locally
        signature=signature,
    )
...
model_version = mlflow.register_model(
    model_uri=f"runs:/{run_id}/pyfunc-sleep-efficiency-model", name=model_name, tags={"git_sha": f"{git_sha}"}
)
# COMMAND ----------
